                ...
                menu_infos.map((i, index )=> {
                  return (
                    <li className="nav-li" key={"nav-li" + index}
                      ...
                      <div><a href="javascript:;" onClick={onNavLiClick.bind(this, index)}>{i.title}</a></div>  
                    </li>
                  )
                })
                ) : <Loading></Loading>
